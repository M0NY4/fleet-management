...
export function AddDriverDocumentModal({ open, onOpenChange, driverName, onAdd, renewDoc }) {
      ...
      <DialogContent className="max-w-md">
        <DialogHeader>
          <DialogTitle className="text-xl font-black uppercase tracking-tight">
            {renewDoc ? "Renew Driver Document" : "Add Driver Document"}
          </DialogTitle>
          <p className="text-xs font-bold text-muted-foreground uppercase tracking-widest">For Driver: {driverName}</p>
        </DialogHeader>
        <form onSubmit={handleSubmit} className="space-y-6 py-4">
          <div className="space-y-2">
            ...
            <Input 
              id="docType" 
              name="docType" 
              placeholder="e.g. License, Medical, etc." 
